...
```{r}
meth.stranded <- methylKit::unite(myobj_18, destrand=FALSE)
meth.destrand <- methylKit::unite(myobj_18, destrand=TRUE)
```
...
meth.destranded.df$siteID <- with(meth.destranded.df, paste(chr, start, sep="_"))  #merge id columns into 1
...
write.table(counts.tot.destrand.10x75, file = "../analyses/counts.tot.destrand.10x75.txt", sep = "\t", row.names = FALSE,  quote = FALSE)
write.table(counts.tot.destrand.5x75, file = "../analyses/counts.tot.destrand.5x75.txt", sep = "\t", row.names = FALSE,  quote = FALSE)
write.table(counts.meth.destrand.10x75, file = "../analyses/counts.meth.destrand.10x75.txt", sep = "\t", row.names = FALSE,  quote = FALSE)
write.table(counts.meth.destrand.5x75, file = "../analyses/counts.meth.destrand.5x75.txt", sep = "\t", row.names = FALSE,  quote = FALSE)
```
