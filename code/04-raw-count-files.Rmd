...
meth.destranded.df$siteID <- with(meth.destranded.df, paste0(chr, start, strand))  #merge id columns into 1
...
```{r}
write.csv(counts.tot.stranded, file = "analyses/counts-total-stranded.csv", row.names = FALSE)
write.csv(counts.meth.stranded, file = "analyses/counts-meth-stranded.csv", row.names = FALSE)
write.csv(counts.tot.destrand, file = "analyses/counts-total-destrand.csv", row.names = FALSE)
write.csv(counts.meth.destrand, file = "analyses/counts-meth-destrand.csv", row.names = FALSE)
```
