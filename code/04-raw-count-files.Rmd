...
Save only the 3 columns I need for MACAU. Don't include rownames or column names. 

```{r}
write.table(size.macau[c(1,4:5)],  file="data/size.macau.txt", sep="\t", row.names = FALSE, col.names = FALSE)
```
