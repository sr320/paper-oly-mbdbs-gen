...
**Supplemental Figure 3**: Gene body methylation patterns. A) relative location of methylation within gene bodies in _Ostrea lurida_. For this analysis methylated loci were designated as those with >50% methylation when averaged across all MBD18 samples, B) percent methylation across a gene body averaged across all MBD18 samples, and C) variation in percent methylation across a gene body, across all MBD18 samples.    

---

**Supplemental Table 1**:  Biological functions that are enriched in the _Ostrea lurida_ genome. Also available in .csv format, [methylated-loci-enriched-BP.csv](https://github.com/sr320/paper-oly-mbdbs-gen/blob/master/analyses/methylation-characteristics/methylated-loci-enriched-BP.csv)   
...
**Supplemental Table 2**: GO terms and GO Slim terms of biological functions enriched in DMGs & DMLs. EASE scores shown. FDR for all terms is 1.0. Also available in .csv format, [DMG-DML-EnrichedBP.csv](https://github.com/sr320/paper-oly-mbdbs-gen/blob/master/analyses/DMG-DML-EnrichedBP.csv)  
