...
**Supplemental Table 3**:  Biological functions that are enriched in the _Ostrea lurida_ genome. Also available in .csv format: https://github.com/sr320/paper-oly-mbdbs-gen/blob/master/analyses/methylation-characteristics/methylated-loci-enriched-BP.csv 
