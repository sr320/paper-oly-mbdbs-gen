...
```{r, message=FALSE, warning=FALSE}
macau75files <- c("macau75-CDS.bed", "macau75-exon.bed", "macau75-gene.bed", "macau75-mRNA.bed", "macau75-ASV.bed", "macau75-intragenic.bed")
...
names(macau75.features) <- c("macau75.CDS", "macau75.exon","macau75.gene", "macau75.mRNA", "macau75.ASV", "macau75.intragenic")
...
macau75.features[[5]] <- macau75.features[[5]] %>% mutate_at("unknown1", as.character)
macau75.features.df <- bind_rows(macau75.features[-5:-6])
print(macau75.summary <- table(macau75.features.df[c("feature")])) #NOTE this does not contain alternative splice variants 
```
...
write_csv(macau75.features.df, path = here::here("analyses/", "macau/", "macau75.features.csv")) #write out df with all MACAU features 
write(macau75.GO$GO_term, file = here::here("analyses/", "macau/", "macau75.GO.txt")) #write out df with just GO terms 
write.table(subset(macau75.features.df, feature=="gene"), here::here("analyses/", "macau/", "macau75.genes.txt"), sep = "\t") #write out gene info for MACAU loci to associate with UniprotIDs
...
write.table(subset(DML.features.df, feature=="gene"), here::here("analyses/", "macau/", "macau75.genes.txt"), sep = "\t") #write out gene info for DMLs to associate with UniprotIDs
...
write.table(subset(allLoci.features.df, feature=="gene"), here::here("analyses/", "macau/", "macau75.genes.txt"), sep = "\t") #write out gene info for All loci fed into MACAU to associate with UniprotIDs
