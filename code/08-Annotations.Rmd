...
DMLfiles <- c("DML-CDS.txt", "DML-exon.txt", "DML-gene.txt", "DML-mRNA.txt", "DML-TE.txt", "DML-ASV.txt", "DML-intragenic.txt")
DML.features <- list()
for (i in c(1:7)) {
...
```{r, message=FALSE, warning=FALSE}
macau75files <- c("macau75-CDS.txt", "macau75-exon.txt", "macau75-gene.txt", "macau75-mRNA.txt", "macau75-ASV.txt", "macau75-intragenic.txt")
...
```{r, message=FALSE, warning=FALSE}
allLocifiles <- c("AllLoci-CDS.txt", "AllLoci-exon.txt", "AllLoci-gene.txt", "AllLoci-mRNA.txt", "AllLoci-TE.txt", "AllLoci-ASV.txt", "AllLoci-intragenic.txt")
