...
perc_meth_bins_1kb_Pst <- Pst(perc_meth_bins_1kb_wide)
#Pst(perc_meth_bins_1kb_wide, ci=1)
...
head(perc_meth_bins_1kb_Pst %>% separate(Quant_Varia, into=c("contig","start.bin", "end.bin"), sep = "_", remove = FALSE))

# Write out Pst results 
write.table(perc_meth_bins_1kb_Pst %>% separate(Quant_Varia, into=c("contig","start.bin", "end.bin"), sep = "_", remove = FALSE), file = here::here("analyses", "methylation-filtered", "Pst_bins_1kb.tab"), sep = '\t', na = "NA", row.names = FALSE, col.names = TRUE)
```
...
#Now run the following line and it will provide Pst estimates for every gene.
perc_meth_bins_10kb_Pst <- Pst(perc_meth_bins_10kb_wide)
...
# Write out Pst results 
write.table(perc_meth_bins_10kb_Pst %>% separate(Quant_Varia, into=c("contig","start.bin", "end.bin"), sep = "_", remove = FALSE), file = here::here("analyses", "methylation-filtered", "Pst_bins_10kb.tab"), sep = '\t', na = "NA", row.names = FALSE, col.names = TRUE)
```