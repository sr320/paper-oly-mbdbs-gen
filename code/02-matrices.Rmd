...
write.csv(melt(as.matrix(dist.manhat.10), varnames = c("row", "col")), file="analyses/dist.manhat.10.csv", row.names=FALSE) 
...
write.csv(melt(as.matrix(dist.manhat.5), varnames = c("row", "col")), file="analyses/dist.manhat.5.csv", row.names=FALSE)
```
