...
-P . \
-A *sorted.bam \
https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/063022-olymerge-snp/
```
...
cd /home/shared/8TB_HDD_01/sr320/github/paper-oly-mbdbs-gen/data/
    ...
    bgdata/v99/zr1394_all_s456_trimmed_bismark_bt2.deduplicated.sorted.bam \
    --fa bgdata/Olurida_v081-mergecat99.fa \
    --output ../analyses/99-bs-snp/all.SNP-candidates.txt \
    --methcg ../analyses/99-bs-snp/all.CpG-meth-info.tab \
    --methchg ../analyses/99-bs-snp/all.CHG-meth-info.tab \
    --methchh ../analyses/99-bs-snp/all.CHH-meth-info.tab \
    > ../analyses/99-bs-snp/SNP.out
```
