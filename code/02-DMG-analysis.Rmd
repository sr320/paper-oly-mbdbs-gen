...
- List of DMGs inputted to DAVID (downloaded from DAVID, which also shows the Uniprot IDs that were excluded from the analysis): analyses/DMGs/Genes-DAVID-DMGs.txt 
...
save(genes_2kbslop_5loci_Pst, file =here::here("analyses", "DMGs", "genes_2kbslop_5loci_Pst"))
...
load(file = "../analyses/methylation-filtered/R-objects/genes_2kbslop_Pst") #load object if needed
...
```{r}
save(meth_filter_genes, file="../analyses/methylation-filtered/meth_filter_genes") 
```
