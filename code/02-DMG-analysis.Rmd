...
genes_2kbslop_Pst_DMGpvalue <- merge(x=genes_2kbslop_Pst,  
...
library(ggpmisc)
formula <- genes_2kbslop_Pst_DMGpvalue$Pst_Values ~ genes_2kbslop_Pst_DMGpvalue$adj.pval.pop

ggplot(genes_2kbslop_Pst_DMGpvalue, aes(x=adj.pval.pop, y=Pst_Values)) +
  ...
  xlab("P-Adjusted from diff. methylated gene region analysis") +
  ylab("Pst values, gene regions") + 
  ggtitle("Gene Region Pst ~ P-Adjusted") +
